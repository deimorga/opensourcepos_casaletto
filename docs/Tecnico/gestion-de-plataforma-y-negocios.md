...
| ~~Candado de las tres claves de cableado~~ | **Escrito el 2026-09-01, sin desplegar y sin certificar.** `Wiring_lock` + `Config::refuse_wired_changes()` + las dos vistas (§9.13) |
