...
return [
    ...
    "dashboard"                      => "Tablero",
    "date"                           => "Fecha",
    "date_invalid"                   => "La fecha «{0}» no es válida. Escríbala como en este ejemplo: {1}.",
    "date_reordered"                 => "se reacomodó al orden día/mes/año",
    "date_not_real"                  => "Esta fecha no existe. Revise el día y el mes.",
    "delete"                         => "Borrar",
    "det"                            => "detalles",
