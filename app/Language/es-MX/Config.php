...
return [
    ...
    "scale_port"                                => "Puerto",
    "scale_port_help"                           => "Identificador que el programa de la caja tiene que abrir, por ejemplo COM3.",
    "scale_port_invalid"                        => "El puerto no puede pasar de 255 caracteres.",
