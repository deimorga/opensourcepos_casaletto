...
return [
    ...
    "order_tickets_configuration"               => "Configuración de Comandas",
    "order_tickets_enable"                      => "Habilitar comandas",
    "order_tickets_enable_help"                 => "Las comandas necesitan Mesas: para usar comandas, active primero Mesas en la pestaña Mesas.",
    "order_tickets_kitchen_enable"              => "Habilitar pantalla de cocina",
    "order_tickets_kitchen_help"                => "La pantalla de cocina todavía no está disponible. Este interruptor queda listo para cuando llegue.",
    "order_tickets_requires_tables"             => "Para usar comandas, active primero Mesas en la pestaña Mesas.",
    ...
    "open_cash_drawer_behaviour"                => "Abrir el cajón al finalizar la venta",
    "open_cash_drawer_behaviour_help"           => "El cajón cuelga de la impresora de recibos, así que se le envía una orden de control: no se imprime nada. Funciona tal cual con cualquier impresora ESC/POS, sin configurar nada. «Solo en pagos en efectivo» es lo habitual en un mostrador: un cajón que se abre en un pago con tarjeta se nota enseguida.",
    "open_cash_drawer_never"                    => "No abrirlo",
    "open_cash_drawer_cash"                     => "Solo en pagos en efectivo",
    "open_cash_drawer_always"                   => "En toda venta",
    ...
    "quick_cash_enable"                         => "",
    "quote_default_comments"                    => "Comentario de las cotizaciones",
    ...
    "receipt_short"                             => "Short",
    "receipt_paper"                             => "Papel del recibo",
    "receipt_paper_help"                        => "El papel en el que se imprime el recibo. Déjelo en el predeterminado del sistema salvo que la caja use rollo de tirilla; un rollo necesita que el recibo se maquete a su ancho, o los totales se salen por el borde derecho.",
    "receipt_paper_system"                      => "Predeterminado del sistema",
    "receipt_paper_58mm"                        => "Rollo de 58 mm",
    "receipt_paper_80mm"                        => "Rollo de 80 mm",
    ...
    "sales_quote_format"                        => "Formato del número de cotización",
    ...
    "scale"                                     => "Báscula",
    "scale_apply_suggestion"                    => "Usarlo",
    "scale_configuration"                       => "Configuración de la Báscula",
    "scale_divisor"                             => "Divisor",
    "scale_divisor_help"                        => "1 si la trama viene en kilogramos, 1000 si viene en gramos.",
    "scale_divisor_invalid"                     => "El divisor tiene que ser un número entero de 1 o más.",
    "scale_format"                              => "Patrón de la trama",
    "scale_format_help"                         => "Patrón con un token de peso {W:n}, máximo 255 caracteres. N{W:6} lee N12.395. Déjelo vacío si en esta caja no hay báscula.",
    "scale_format_invalid"                      => "El patrón no es utilizable. Necesita un token {W:n}, tiene que ser un patrón válido y no puede pasar de 255 caracteres.",
    "scale_preview_empty"                       => "Pegue una trama para probarla.",
    "scale_preview_no_format"                   => "Escriba un patrón contra el cual probar la trama.",
    "scale_preview_no_match"                    => "El patrón no engancha con esta trama.",
    "scale_preview_ok"                          => "El patrón engancha con esta trama.",
    "scale_preview_weight"                      => "Peso leído (kg)",
    "scale_raw"                                 => "Trama capturada",
    "scale_raw_help"                            => "Pegue lo que emitió la báscula, tal cual salió del puerto. Los caracteres de control y los espacios de los extremos se ignoran acá, igual que los ignora la caja.",
    "scale_suggestion"                          => "Patrón sugerido",
    "scale_suggestion_help"                     => "Sacado de esta única trama. El relleno que cambia de ancho entre lecturas no se puede ver en una sola: si la siguiente trama falla, cambie los espacios por \s+.",
    "scale_test"                                => "Probar una trama capturada",
    "scale_transport"                           => "Transporte",
    "scale_transport_agent"                     => "Programa local (puerto serie)",
    "scale_transport_help"                      => "Por dónde llega el peso a esta página. El programa de la caja entrega la trama cruda; esta pantalla decide qué significa.",
    "scale_transport_keys"                      => "Teclado (la báscula digita el peso)",
    "security_issue"                            => "Security Vulnerability Warning",
    "server_notice"                             => "Please use the below info for issue reporting.",
    "service_charge"                            => "",
    "shortcuts"                                 => "Atajos",
    "shortcuts_configuration"                   => "Configuración de atajos de teclado de ventas",
    "shortcuts_duplicate_bindings"              => "Los atajos no se pueden repetir.",
    "shortcuts_save_error"                      => "No se pudo guardar la configuración de atajos.",
    "show_due_enable"                           => "",
    ...
    "tables_required_by_order_tickets"          => "Las comandas están encendidas y necesitan Mesas. Apague primero las comandas en la pestaña Comandas.",
