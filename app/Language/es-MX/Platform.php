...
return [
    ...
    "totp_enroll_intro"      => "Escanee la imagen con su aplicación, o escriba la clave a mano. Después escriba el código que le muestre: no se activa nada hasta que un código real demuestre que funciona.",
    "totp_secret_label"      => "Clave de configuración",
    "totp_secret_help"       => "Solo hace falta si no se puede escanear la imagen. Se muestra una vez y no se vuelve a mostrar.",
    "totp_qr_alt"            => "Código de configuración para la aplicación de autenticación",
