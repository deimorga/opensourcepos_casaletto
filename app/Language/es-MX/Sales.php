...
return [
    ...
    "quote_document"                   => "Cotización",
    "quote_download_pdf"               => "Descargar PDF",
    "quote_no_payments"                => "Una cotización no lleva pagos: quite los pagos y vuelva a cotizar.",
    "quote_not_found"                  => "Esa cotización no existe.",
    "quote_total"                      => "Total cotizado",
    "quote_valid_until"                => "Válida hasta",
    "quote_view"                       => "Ver cotización",
    ...
    // artículo, y hoy el kilogramo es la única unidad al peso que existe
