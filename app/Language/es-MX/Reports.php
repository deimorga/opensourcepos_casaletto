...
return [
    ...
    "analytical_reports"                        => "Reportes Analíticos",
    "income_expenses"                           => "Ingresos vs Gastos",
    "income"                                    => "Ingresos",
    "income_collected"                          => "Ingresos cobrados",
    "result"                                    => "Resultado",
    "margin"                                    => "Margen",
    "period"                                    => "Período",
    ...
    "no_data_for_period"                        => "Sin datos para el período seleccionado",
