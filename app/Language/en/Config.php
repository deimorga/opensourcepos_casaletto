...
return [
    ...
    "order_tickets_configuration"               => "Order Tickets Configuration",
    "order_tickets_enable"                      => "Enable Order Tickets",
    "order_tickets_enable_help"                 => "Order tickets need Tables: to use order tickets, first enable Tables in the Table tab.",
    "order_tickets_kitchen_enable"              => "Enable Kitchen Screen",
    "order_tickets_kitchen_help"                => "The kitchen screen is not available yet. This switch is ready for when it arrives.",
    "order_tickets_requires_tables"             => "To use order tickets, first enable Tables in the Table tab.",
    ...
    "open_cash_drawer_behaviour"                => "Open cash drawer after a sale",
    "open_cash_drawer_behaviour_help"           => "The drawer hangs off the receipt printer, so this sends it a control sequence -- nothing is printed. Works as shipped with any ESC/POS printer; nothing to configure per shop. \"Only on cash payments\" is what a counter normally wants: a drawer that pops on a card payment is noticed straight away.",
    "open_cash_drawer_never"                    => "Do not open it",
    "open_cash_drawer_cash"                     => "Only on cash payments",
    "open_cash_drawer_always"                   => "On every sale",
    ...
    "receipt_paper_help"                        => "The paper the receipt is printed on. Leave it on the system default unless the till uses a till roll; a roll needs the receipt laid out for its width or the totals fall off the right edge.",
    "receipt_paper_system"                      => "System default",
    "receipt_paper_58mm"                        => "58 mm roll",
    "receipt_paper_80mm"                        => "80 mm roll",
    ...
    "scale"                                     => "Scale",
    "scale_apply_suggestion"                    => "Use it",
    "scale_configuration"                       => "Scale Configuration",
    "scale_divisor"                             => "Divisor",
    "scale_divisor_help"                        => "1 when the frame carries kilograms, 1000 when it carries grams.",
    "scale_divisor_invalid"                     => "The divisor must be a whole number of 1 or more.",
    "scale_format"                              => "Frame pattern",
    "scale_format_help"                         => "Pattern with a {W:n} weight token, at most 255 characters. N{W:6} reads N12.395. Leave it empty when there is no scale on this till.",
    "scale_format_invalid"                      => "The pattern is not usable. It needs a {W:n} token, has to be a valid pattern, and cannot exceed 255 characters.",
    "scale_preview_empty"                       => "Paste a frame to test.",
    "scale_preview_no_format"                   => "Enter a pattern to test the frame against.",
    "scale_preview_no_match"                    => "The pattern does not match this frame.",
    "scale_preview_ok"                          => "The pattern matches this frame.",
    "scale_preview_weight"                      => "Weight read (kg)",
    "scale_raw"                                 => "Captured frame",
    "scale_raw_help"                            => "Paste what the scale emitted, exactly as it came off the port. Control characters and the blanks around them are ignored here, the same way the till ignores them.",
    "scale_suggestion"                          => "Suggested pattern",
    "scale_suggestion_help"                     => "Read off this one frame. Padding that changes width between readings cannot show up in a single frame: if the next frame fails, replace the blanks with \s+.",
    "scale_test"                                => "Test a captured frame",
    "scale_transport"                           => "Transport",
    "scale_transport_agent"                     => "Local program (serial port)",
    "scale_transport_help"                      => "How the weight reaches this page. The program on the till hands over the raw frame; this screen decides what it means.",
    "scale_transport_keys"                      => "Keyboard (the scale types the weight)",
    ...
    "tables_required_by_order_tickets"          => "Order tickets are on and need Tables. Turn order tickets off first, in the Order Tickets tab.",
