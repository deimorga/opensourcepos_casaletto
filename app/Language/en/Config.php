...
return [
    ...
    "open_cash_drawer_on_sale_help"             => "Pops the drawer when a sale is completed. The drawer hangs off the receipt printer, so this sends it a control sequence -- nothing is printed. Works as shipped with any ESC/POS printer; nothing to configure per shop. Leave it off if this counter has no drawer.",
