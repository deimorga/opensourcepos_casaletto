...
return [
    ...
    "quote_no_payments"                => "A quote carries no payments. Remove the payments and quote again.",
    "quote_not_found"                  => "That quote does not exist.",
    ...
    "show_kit_ingredients"             => "Show ingredients",
    ...
    "scale_kept"                         => "The scale is empty: the last weight is kept.",
