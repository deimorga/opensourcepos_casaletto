...
return [
    ...
    "dashboard"                      => "",
    "date"                           => "Date",
    "date_invalid"                   => "The date «{0}» is not a real date. Write it like this example: {1}.",
    "date_reordered"                 => "rearranged to the business’s day/month order",
    "date_not_real"                  => "This date does not exist. Check the day and the month.",
    "delete"                         => "Delete",
    "det"                            => "details",
